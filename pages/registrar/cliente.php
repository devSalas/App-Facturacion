...
<body class="m-auto">
    <header>
        <h1 class="text-2xl text-center p-4" >Agregar Clientes</h1>
    </header>
    ...
    <main>
        <form method="POST" action="../../services/Procesar_cliente.php" >
            <label for="nombre">Nombre del Cliente:</label>
            <input class="text-black p-2" type="text" name="nombre" required><br><br>

            <label for="direccion">Dirección:</label>
            <textarea class="text-black p-2" name="direccion"></textarea><br><br>

            <label for="telefono">Telefono:</label>
            <input class="text-black p-2" type="number" name="telefono" step="0.01" required><br><br>

            <label for="email">Correo electronico:</label>
            <input class="text-black p-2" type="email" name="email" required><br><br>

            <input class="bg-slate-700" type="submit" name="agregar" value="Agregar cliente">
        </form>
    </main>
    <footer>
